...
public final class ComponentPacksActivity extends Activity {
    ...
    private static final String FUNCTION_PACK_URL=
            "https://github.com/vinay1997mishra/voice-chat-app/releases/download/anamika-functionpack-current/AnamikaAI-13-FunctionPack.zip";
    ...
    private void buildUi(){
        ...
        Button functionPack=new Button(this); functionPack.setText("Install / Update Function Pack");
        ...
        functionPack.setOnClickListener(v->download(FUNCTION_PACK_URL));
