        ...
        builder: (dialogContext, controller) => StatefulBuilder(
          builder: (context, setLocal) {
            ...
            return StatefulBuilder(
              builder: (context, setErrorState) => AlertDialog(
                title: Text(
                  widget.room.locked ? 'Change Room PIN' : 'Set Room Lock',
                ),
                content: TextField(
                  ...
                  FilledButton(
                    ...
                    onPressed: () {
                      ...
                      if (!RegExp(r'^\d{4,6}$').hasMatch(value)) {
                        setErrorState(() {
                          errorText = 'PIN must be 4 to 6 digits';
                        });
                        return;
                      }
                    ...
                    child: Text(
                      widget.room.locked ? 'Save PIN' : 'Set Lock',
                    ),
                  ),
                ],
              ),
