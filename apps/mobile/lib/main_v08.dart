  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        if (locked) TextField(controller: pin, keyboardType: TextInputType.number, maxLength: 6, decoration: const InputDecoration(labelText: 'Room PIN (4–6 digits)', border: OutlineInputBorder())),
        FilledButton(
            ...
            children: [
              ...
              if (enabled)
                TextField(
                  ...
                  obscureText: true,
                  maxLength: 6,
                  decoration: const InputDecoration(labelText: 'Room PIN (4–6 digits)', border: OutlineInputBorder()),
                ),
            ],
          ),
          actions: [
